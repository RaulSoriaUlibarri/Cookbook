...
export default function HeroCarousel() {
  ...
  return (
    <div className="md:flex md:justify-center md:items-center lg:px-20 lg:mt-10">
      <h2 className="my-3 px-5 font-bold text-2xl text-gray-900 md:hidden lg:text-3xl">
      ...
      <div className="mx-7 my-5 h-full md:ml-8 md:mr-0 md:max-w-md">
        <h2 className="hidden mb-5 text-3xl font-bold text-gray-900 md:block md:text-left lg:text-4xl lg:mb-8">
          Discover and Cook your Favorite Recipes
        </h2>
        <p className="text-gray-700 leading-relaxed text-justify md:text-left lg:text-lg lg:leading-loose">
