  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger>
        <button
          onClick={() => fetchMeal}
          className="w-full rounded-xl border-[1px] border-black hover:text-customPurple hover:border-customPurple dark:border-slate-600"
        >
          Read Recipe
        </button>
      </Dialog.Trigger>
        ...
        <div>
          ...
          >
            <div
              ...
              className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -tranlate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            />
          </div>
